...
import { reactive, ref, onMounted, toggleMenu, submitForm } from '@vue/composition-api'
import { stripscript, validataEmail, validataPass, validateVCode } from "utils/validata"
export default {
    name: "login",
